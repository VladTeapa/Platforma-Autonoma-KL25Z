...
void SetareViteza(float viteza); // Setare viteza, valoarea trebuie sa fie intre 0 si 1
void SetareSens(int sens); // Setare sens, folositi macrodefinitiile
void SetareUnghi(float unghi); // Setare unghi, valoarea trebuie sa fie intre -1 si 1
